                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('dashboard.brands.index') }}"> العلامات
                                        التجارية
                                    </a>
                                </li>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="status" id="" class="form-control">
                                                                <option value="" selected disabled> -- حالة العلامة
                                                                    التجارية --
                                                                </option>
                                                                <option value="1" @selected($brand['status'] == 1)> مفعل
                                                                </option>
                                                                <option value="0" @selected($brand['status'] == 0)> غير
                                                                    مفعل
                                                                </option>
                                                            </select>
                                                        </div>
