                            ...
                            <div class="m-0 card border-grey border-lighten-3">
                                <div class="border-0 card-header">
                                    <div class="text-center card-title">
                                        <img style="width: 150px" src="{{ $setting->getLogo() }}"
                                            alt=" {{ $setting->name }} ">
                                        <h1 class="" style="color: {{ $setting->main_color }}"> {{ $setting->name }} </h1>
                                    </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="POST"
                                            ...
                                            <button style="background-color:{{ $setting->secondary_color }};color:#fff;" type="submit" class="btn btn-block btn-lg"><i
