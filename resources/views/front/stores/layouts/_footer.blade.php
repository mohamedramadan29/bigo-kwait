<section class="product footer" style="background-image: url('{{ asset('assets/front/stores/') }}/images/homepage-one//footer-bg.webp')">
    <div class="container">
            ...
            <div class="row gy-5">
                <div class="col-lg-3 col-sm-6">
                    <div class="footer-order">
                        <div class="logo">
                            <img src="{{ asset('assets/front/stores/') }}/images/logos/footer-logo.webp" alt="logo">
                        </div>
