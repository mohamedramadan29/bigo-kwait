...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/front/stores/') }}/images/homepage-one/icon.png">

    <title>Shopus: Your One-Stop Destination for Fashion and Style</title>

    <link rel="stylesheet" href="{{ asset('assets/front/stores/') }}/css/swiper10-bundle.min.css">

    <link rel="stylesheet" href="{{ asset('assets/front/stores/') }}/css/bootstrap-5.3.2.min.css">

    <link rel="stylesheet" href="{{ asset('assets/front/stores/') }}/css/nouislider.min.css">

    <link rel="stylesheet" href="{{ asset('assets/front/stores/') }}/css/aos-3.0.0.css">

    <link rel="stylesheet" href="{{ asset('assets/front/stores/') }}/css/style.css">
</head>
...
<body>
        ...
        <div class="header-center-section d-none d-lg-block">
            <div class="container">
                <div class="header-center">
                    <div class="logo">
                        <a href="index-2.html">
                            <img src="{{ asset('assets/front/stores/') }}/images/logos/logo.webp" alt="logo">
                        </a>
                    </div>
                            ...
                            <div class="cart-submenu">
                                <div class="cart-wrapper-item">
                                    <div class="wrapper">
                                        <div class="wrapper-item">
                                            <div class="wrapper-img">
                                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/product-img/product-img-1.webp"
                                                    alt="img">
                                            </div>
                                    ...
                                    <div class="wrapper">
                                        <div class="wrapper-item">
                                            <div class="wrapper-img">
                                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/product-img/product-img-2.webp"
                                                    alt="img">
                                            </div>
                                            <div class="wrapper-content">
                                    ...
                                    <div class="wrapper">
                                        <div class="wrapper-item">
                                            <div class="wrapper-img">
                                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/product-img/product-img-3.webp"
                                                    alt="img">
                                            </div>
                                            <div class="wrapper-content">
                                    ...
                                    <div class="wrapper">
                                        <div class="wrapper-item">
                                            <div class="wrapper-img">
                                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/product-img/product-img-4.webp"
                                                    alt="img">
                                            </div>
                                            <div class="wrapper-content">
                                    ...
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/dresses.webp"
                                                    alt="dress">
                                            </span>
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/bags.webp"
                                                    alt="Bags">
                                            </span>
                                            <span class="dropdown-text">
                                                Bags
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/sweaters.webp"
                                                    alt="sweaters">
                                            </span>
                                            <span class="dropdown-text">
                                                Sweaters
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/shoes.webp"
                                                    alt="sweaters">
                                            </span>
                                            <span class="dropdown-text">
                                                Boots
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/gift.webp"
                                                    alt="gift">
                                            </span>
                                            <span class="dropdown-text">
                                                Gifts
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/sneakers.webp"
                                                    alt="sneakers">
                                            </span>
                                            <span class="dropdown-text">
                                                Sneakers
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/watch.webp"
                                                    alt="watch">
                                            </span>
                                            <span class="dropdown-text">
                                                Watches
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/ring.webp"
                                                    alt="ring">
                                            </span>
                                            <span class="dropdown-text">
                                                Gold Ring
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/cap.webp"
                                                    alt="cap">
                                            </span>
                                            <span class="dropdown-text">
                                                Cap
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/glass.webp"
                                                    alt="glass">
                                            </span>
                                            <span class="dropdown-text">
                                                Sunglasses
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/baby.webp"
                                                    alt="baby">
                                            </span>
                                            <span class="dropdown-text">
                                                Baby Shop
                            ...
                            <li class="mega-menu">
                                ...
                                <div class="shop-menu">
                                    ...
                                    <div class="shop-menu-img">
                                        <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/empty-wishlist.webp" alt="img">
                                    </div>
                                </div>
                            </li>
                            <li>
    ...
    <section id="hero" class="hero">
        <div class="swiper hero-swiper">
            <div class="swiper-wrapper hero-wrapper">
                <div class="swiper-slide hero-slider-one" style="background-image: url('{{ asset('assets/front/stores/') }}/images/homepage-one/hero-slider-one.webp')">
                    <div class="container">
                        <div class="col-lg-6">
                ...
                <div class="swiper-slide hero-slider-two"  style="background-image: url('{{ asset('assets/front/stores/') }}/images/homepage-one/hero-slider-two.webp')">
                    <div class="container">
                        <div class="col-lg-6">
                ...
                <div class="swiper-slide hero-slider-three"  style="background-image: url('{{ asset('assets/front/stores/') }}/images/homepage-one/hero-slider-three.webp')">
                    <div class="container">
                        <div class="col-lg-6">
                            <div class="wrapper-section">
                                <div class="wrapper-info">
        ...
        <div class="container">
            <div class="style-section">
                <div class="row gy-4 gx-5 gy-lg-0">
                    <div class="col-lg-6">
                        <div class="product-wrapper wrapper-one" data-aos="fade-right"  style="background-image: url('{{ asset('assets/front/stores/') }}/images/homepage-one/style-bg-one.webp')">
                            <div class="wrapper-info">
        ...
        <div class="container">
            ...
            <div class="category-section">
                <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                    <div class="wrapper-img">
                        <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/dresses.webp" alt="dress">
                    </div>
                    <div class="wrapper-info">
                ...
                <div class="product-wrapper" data-aos="fade-right" data-aos-duration="200">
                    <div class="wrapper-img">
                        <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/bags.webp" alt="dress">
                    </div>
                    <div class="wrapper-info">
                ...
                <div class="product-wrapper" data-aos="fade-right" data-aos-duration="300">
                    <div class="wrapper-img">
                        <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/sweaters.webp" alt="dress">
                    </div>
                    <div class="wrapper-info">
                ...
                <div class="product-wrapper" data-aos="fade-right" data-aos-duration="400">
                    <div class="wrapper-img">
                        <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/shoes.webp" alt="dress">
                    </div>
                    <div class="wrapper-info">
                ...
                <div class="product-wrapper" data-aos="fade-right" data-aos-duration="500">
                    <div class="wrapper-img">
                        <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/gift.webp" alt="dress">
                    </div>
                    <div class="wrapper-info">
                ...
                <div class="product-wrapper" data-aos="fade-right" data-aos-duration="600">
                    <div class="wrapper-img">
                        <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/sneakers.webp" alt="dress">
                    </div>
                    <div class="wrapper-info">
                ...
                <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                    <div class="wrapper-img">
                        <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/watch.webp" alt="dress">
                    </div>
                    <div class="wrapper-info">
                ...
                <div class="product-wrapper" data-aos="fade-right" data-aos-duration="200">
                    <div class="wrapper-img">
                        <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/ring.webp" alt="dress">
                    </div>
                    <div class="wrapper-info">
                ...
                <div class="product-wrapper" data-aos="fade-right" data-aos-duration="300">
                    <div class="wrapper-img">
                        <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/cap.webp" alt="dress">
                    </div>
                    <div class="wrapper-info">
                ...
                <div class="product-wrapper" data-aos="fade-right" data-aos-duration="400">
                    <div class="wrapper-img">
                        <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/glass.webp" alt="dress">
                    </div>
                    <div class="wrapper-info">
                ...
                <div class="product-wrapper" data-aos="fade-right" data-aos-duration="500">
                    <div class="wrapper-img">
                        <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/category-img/baby.webp" alt="dress">
                    </div>
                    <div class="wrapper-info">
        ...
        <div class="container">
            ...
            <div class="brand-section">
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/brand-img-1.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/brand-img-2.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/brand-img-3.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/brand-img-4.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/brand-img-5.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/brand-img-6.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/brand-img-7.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/brand-img-8.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/brand-img-9.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/brand-img-10.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/brand-img-11.webp" alt="img">
                        </a>
                    </div>
                </div>
                <div class="product-wrapper">
                    <div class="wrapper-img">
                        <a href="product-sidebar.html">
                            <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/brand-img-12.webp" alt="img">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="arrival-section">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/product-img/product-img-5.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/product-img/product-img-6.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/product-img/product-img-7.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/product-img/product-img-8.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
            ...
            <div class="flash-sale-section">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right" data-aos-duration="400">
                            <div class="product-img">
                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/product-img/product-img-9.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
            ...
            <div class="top-selling-section">
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/product-img/product-img-10.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
    ...
    <section class="product weekly-sale">
        <div class="container">
            ...
            <div class="style-section">
                <div class="row gy-4 gx-5 gy-lg-0">
                    <div class="col-lg-6">
                        <div class="product-wrapper wrapper-one" data-aos="fade-right" style="background-image: url('{{ asset('assets/front/stores/') }}/images/homepage-one/style-bg-three.webp')">
                            <div class="wrapper-info">
                                <span class="wrapper-subtitle">NEW STYLE</span>
                                <h4 class="wrapper-details">Get 65% Offer
                                    <span class="wrapper-inner-title">& Make New</span> Fusion.
                    ...
                    <div class="col-lg-6">
                        <div class="product-wrapper wrapper-two" data-aos="fade-up" style="background-image: url('{{ asset('assets/front/stores/') }}/images/homepage-one/style-bg-four.webp')">
                            <div class="wrapper-info">
                                <span class="wrapper-subtitle">Mega OFFER</span>
                                <h4 class="wrapper-details">
                                    Make your New
            ...
            <div class="best-product-section">
                <div class="row g-4">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/product-img/product-img-11.webp"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/product-img/product-img-13.webp"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img src="{{ asset('assets/front/stores/') }}/images/homepage-one/product-img/product-img-12.webp"
                                    alt="product-img">
                            </div>
                            <div class="product-info">
                                <div class="ratings">
    ...
    <script src="{{ asset('assets/front/stores/') }}/js/jquery_3.7.1.min.js"></script>

    <script src="{{ asset('assets/front/stores/') }}/js/bootstrap_5.3.2.bundle.min.js"></script>

    <script src="{{ asset('assets/front/stores/') }}/js/nouislider.min.js"></script>

    <script src="{{ asset('assets/front/stores/') }}/js/aos-3.0.0.js"></script>

    <script src="{{ asset('assets/front/stores/') }}/js/swiper10-bundle.min.js"></script>

    <script src="{{ asset('assets/front/stores/') }}/js/shopus.js"></script>
</body>
