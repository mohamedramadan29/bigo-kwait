                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('user.store.categories') }}"> التصنيفات
                                    </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form method="post" action="{{ route('user.store.categories.create') }}"
                                            ...
                                            <div class="form-body">
                                                <div class="col-xl-12 col-lg-12 ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label for="description" class="form-label"> صورة التصنيف
                                                                </label>
