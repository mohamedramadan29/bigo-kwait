                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ route('user.store.categories.create') }}" class="btn btn-primary"> اضافة تصنيف
                                    جديد </a>
                            </div>
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                @forelse ($categories as $category)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-info btn-sm"
                                                                href="{{ route('user.store.categories.update', $category->id) }}"><i
                                                    ...
                                                    <!-- Modal -->
                                                    @include('front.user.store.categories.delete')
                                                @empty
                                                    <tr>
                                                        <td colspan="5" class="text-center">لا يوجد تصنيفات</td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                                        </table>
