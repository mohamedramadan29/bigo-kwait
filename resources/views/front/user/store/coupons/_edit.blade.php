<!-- Modal -->
<div class="modal fade" id="editcoupon{{ $coupon->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('user.store.coupons.update', $coupon->id) }}" id="edit_coupon_form" method="post">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select name="is_active" id="coupon_is_active" class="form-control" required>
                            ...
                            <option id="coupon_is_active_1" value="1" @selected(old('is_active', $coupon->is_active) == 1)> مفعل </option>
                            <option id="coupon_is_active_0" value="0" @selected(old('is_active', $coupon->is_active) == 0)> غير مفعل </option>
                        </select>
