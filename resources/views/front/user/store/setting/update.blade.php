                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" method="POST" id="invoice-form"
                                            action="{{ route('user.store-setting.update') }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-body">
                                                <!-- باقي الحقول -->
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input required type="text" id="name"
                                                                ...
                                                                value="{{ old('name', $store['setting']->name ?? '') }}">
                                                        </div>
                                                    </div>
                                                    {{-- <div class="col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input required type="email" id="email"
                                                                ...
                                                                value="{{ old('email', $store['setting']->email ?? '') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input required type="text" id="phone"
                                                                ...
                                                                value="{{ old('phone', $store['setting']->phone ?? '') }}">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input required type="text" id="address"
                                                                ...
                                                                value="{{ old('address', $store['setting']->address ?? '') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- اضافة المرفقات -->
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="description" class="form-control">{{ old('description', $store['setting']->description ?? '') }}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="url" id="facebook" class="form-control"
                                                                ...
                                                                value="{{ old('facebook', $store['setting']->facebook ?? '') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="url" id="twitter" class="form-control"
                                                                ...
                                                                value="{{ old('twitter', $store['setting']->twitter ?? '') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="url" id="instagram" class="form-control"
                                                                ...
                                                                value="{{ old('instagram', $store['setting']->instagram ?? '') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="url" id="youtube" class="form-control"
                                                                ...
                                                                value="{{ old('youtube', $store['setting']->youtube ?? '') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="url" id="snapchat" class="form-control"
                                                                ...
                                                                value="{{ old('snapchat', $store['setting']->snapchat ?? '') }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="url" id="tiktok" class="form-control"
                                                                ...
                                                                value="{{ old('tiktok', $store['setting']->tiktok ?? '') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="url" id="whatsapp" class="form-control"
                                                                ...
                                                                value="{{ old('whatsapp', $store['setting']->whatsapp ?? '') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="color" id="main_color" class="form-control"
                                                                ...
                                                                value="{{ old('main_color', $store['setting']->main_color ?? '') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="color" id="second_color" class="form-control"
                                                                ...
                                                                value="{{ old('second_color', $store['setting']->secondary_color ?? '') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
@section('js')
    ...
    <script>
        $("#single-image-edit").fileinput({
            ...
            initialPreview: [
                @if ($store && $store->Setting && $store->Setting->logo)
                    "{{ asset($store->getLogo()) }}"
                @endif
            ],
        });
