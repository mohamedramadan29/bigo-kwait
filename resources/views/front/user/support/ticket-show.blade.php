                ...
                <div class="content-body">
                    <section class="chat-app-window">
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('user.support.tickets') }}"> التذاكر </a>
                                </li>
                        ...
                        <div class="chats">
                            <div class="chats">
                                @foreach ($messages as $message)
                                    ...
                                    <div class="chat @if ($message->sender_username == Auth::user()->username) chat-left @endif">
                                                ...
                                                @if ($message->Files->isNotEmpty())
                                                    @foreach ($message->Files as $file)
                                                        <a class="btn btn-warning btn-sm"
                                                            href="{{ asset('assets/uploads/support_tickets/' . $file->file) }}"
                                                            target="_blank">
                                                            مشاهدة المرفق
                                                        </a>
                                                    @endforeach
                    ...
                    <section class="chat-app-form">
                        <form class="chat-app-input d-flex" method="POST"
                            action="{{ route('user.ticket.sendmessage', $ticket->id) }}" enctype="multipart/form-data">
                            @csrf
